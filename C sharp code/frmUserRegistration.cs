    ...
    public partial class frmUserRegistration : Form
    {
        ...
        private void Update_record_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string cb = "update registration set password='" + txtPassword.Text + "',contactno='" + txtContact_no.Text + "',email='" + txtEmail_Address.Text + "',nameofuser='" + txtName.Text + "',JoiningDate=#" + DateTime.Now + "#, where username='" + txtUsername.Text + "'";
                cmd = new OleDbCommand(cb);
                cmd.Connection = con;
                cmd.ExecuteReader();
                con.Close();
        ...
        private void delete_records()
        {
            ...
            try
            {
                ...
                con = new OleDbConnection(cs);
                con.Open();
                string cz1 = "select username from Registration where username='Admin'";
